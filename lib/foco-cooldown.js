...
const FOCO_COOLDOWN_CAP = 180; /* 3 h — ajuste a mensagem de ajuda em settings.js, se necessário */
 ...
 * Só nesse estado o usuário pode alterar os minutos de “tempo de reflexão”.
...
async function focoCanEditCooldownSetting() {
  ...
  const ptl = d.pendingTimeLimitRemovals;
  if (ptl && typeof ptl === "object" && !Array.isArray(ptl)) {
